<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="Report_Sales_SalesReport, App_Web_q1xedhuo" title="Untitled Page" %>
                				...
                				<table id="TblDemandDate" width="100%" border="0" style="border-right: black 1px solid; border-top: black 1px solid; border-left: black 1px solid; border-bottom: black 1px solid">
                    					<tr>
                      						<td style="text-align: right; width: 50%;">&nbsp;From &nbsp;
                                                  ...
                                                  <IMG style="WIDTH: 37px" id="imgFromDate" alt="Pick Date" src="../../Images/calendar.gif" />
<script language="javascript" type="text/javascript">
...
//                              {
                              ...
                              // }	
                      						...
                      						<td width="50%">
                                                  ...
                                                  <IMG style="WIDTH: 37px" id="imgToDate" alt="Pick Date" src="../../Images/calendar.gif" />
                                                  <script language="javascript" type="text/javascript">
//                            Sys.WebForms.PageRequestManager.getInstance().add_endRequest(EndRequestHandler);
//                              Sys.WebForms.PageRequestManager.getInstance().add_pageLoaded(pageLoadedHandler);
//                              
