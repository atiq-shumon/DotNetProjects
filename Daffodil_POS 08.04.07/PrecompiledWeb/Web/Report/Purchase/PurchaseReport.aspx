<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="Report_Purchase_PurchaseReport, App_Web_fg6bctpe" title="Purchase Report" %>
                				...
                				<table id="TblDemandDate" width="100%" border="0" style="border-right: black 1px solid; border-top: black 1px solid; border-left: black 1px solid; border-bottom: black 1px solid">
                    					<tr>
                      						<td style="text-align: right; width: 50%; vertical-align: middle;">&nbsp;From &nbsp;
                                                  <asp:TextBox ID="txtFromDate" runat="server" MaxLength="10"></asp:TextBox><img id="imgFromDate"
...
//                              {
                              ...
                              // }	
                      						...
                      						<td width="50%" style="vertical-align: middle">
                                                  To &nbsp; &nbsp;<asp:TextBox ID="txtToDate" runat="server" MaxLength="10"></asp:TextBox><img alt="Pick Date" id="imgToDate" src="../../Images/calendar.gif" style="width: 37px; height: 20px;" />
                        <script language="javascript" type="text/javascript">
