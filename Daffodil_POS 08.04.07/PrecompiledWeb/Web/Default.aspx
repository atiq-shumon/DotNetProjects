<%@ page language="C#" autoeventwireup="true" inherits="_Default, App_Web_pgrxecpj" %>
...
<body>
    ...
    <div>
        <p class="MsoNormal" style="margin: 0in 0in 0pt">
            <table border="0" cellpadding="0" cellspacing="0" style="width: 698pt; border-collapse: collapse;
                height: 128px; left: 2px; position: relative; top: 171px;" x:str="">
                <colgroup>
                ...
                <tr height="26" style="font-size: 24pt; height: 19.5pt">
                    <td class="xl23" style="border-left-color: #e0dfe3; border-bottom-color: #e0dfe3;
                        ...
                        <span style="color: #ffffff; background-color: #33ccff"><strong style="vertical-align: middle;
                            ...
                            <asp:TextBox ID="txtComputerName" runat="server" BorderColor="White" BorderStyle="None" style="vertical-align: middle; text-align: center" Font-Bold="True" Font-Size="X-Large"></asp:TextBox><br />
                            <asp:Label ID="Label2" runat="server" BackColor="White" ForeColor="Black" Text="IP Address"></asp:Label><br />
                            <asp:TextBox ID="txtIPAddress" runat="server" BorderColor="White" BorderStyle="None" style="font-weight: bold; vertical-align: middle; text-align: center" Font-Size="X-Large"></asp:TextBox><br />
                            <br />
