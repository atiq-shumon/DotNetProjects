<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="Admin_UserManagement_Default, App_Web_-s9ls25s" title="Untitled Page" %>
        ...
        <table style="font-weight: bold; width: 608px;">
            <tr>
                ...
                <td style="width: 40%; text-align: left">
                    <asp:HyperLink id="HyperLink11" runat="server" Font-Size="12pt" NavigateUrl="~/Admin/Default.aspx" ForeColor="Fuchsia">Go to Home Page</asp:HyperLink></td>
