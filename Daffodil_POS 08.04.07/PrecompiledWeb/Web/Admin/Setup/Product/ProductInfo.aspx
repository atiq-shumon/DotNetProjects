<%@ page language="C#" theme="DPOSThemes" stylesheettheme="DPOSThemes" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="ui_setup_ProductInfo, App_Web_zyhzjyic" title="Product Info" %>
...
</asp:GridView> <asp:ValidationSummary id="ValidationSummary1" runat="server" Width="159px" Height="27px" ValidationGroup="ProductGroupTextField" ShowMessageBox="True" ShowSummary="False"></asp:ValidationSummary> </DIV><asp:ObjectDataSource id="ObjectDataSource1" runat="server" SelectMethod="GetProductInfo" TypeName="DSL.POS.BusinessLogicLayer.Imp.ProductInfoBLImp" DataObjectTypeName="DSL.POS.DTO.DTO.ProductInfoDTO" DeleteMethod="DelProductInfo"></asp:ObjectDataSource> <asp:HiddenField id="hfPrimaryKey" runat="server"></asp:HiddenField> </TD><TD style="WIDTH: 1%; HEIGHT: auto">&nbsp;</TD></TR></TBODY></TABLE></TD></TR><TR><TD vAlign=top align=left></TD></TR></TBODY></TABLE></DIV>
</ContentTemplate>
        </asp:UpdatePanel>
<script language="javascript" type="text/javascript">
