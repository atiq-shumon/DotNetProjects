...
{
  public class ReportStockRegisterInfo
    {
      /// <summary>
        /// Get or set DateSet for Stock Register
      /// </summary>
      ...
      public DataSet GetStockInfo(DateTime DemandStartdate, DateTime DemandEnddate,Guid productCategory, Guid productSubCategory, Guid productBrand, Guid productPK)
      {
          ...
          try
          {
              ...
              cmd.CommandText = "ReptProductStockInfo";
