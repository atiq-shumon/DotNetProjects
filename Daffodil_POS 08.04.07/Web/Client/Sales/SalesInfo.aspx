<%@ Page Language="C#" Theme="DPOSThemes" StylesheetTheme ="DPOSThemes" AutoEventWireup="true" CodeFile="SalesInfo.aspx.cs" Inherits="SalesInfo"  MasterPageFile="~/MasterPage.master" Title ="::.. Sales Info ..::"%>
...
</asp:Label></TD></TR><TR><TD style="HEIGHT: auto" vAlign=top align=left><TABLE width="100%"><TBODY><TR><TD style="WIDTH: 17%"><asp:Label id="InvoiceNo" runat="server" Enabled="False" Visible="False" text="Invoice No"></asp:Label> </TD><TD style="WIDTH: 222px"><asp:TextBox style="VERTICAL-ALIGN: top" id="txtInvoiceNo" runat="server" Width="180px" BorderStyle="Solid" BackColor="Info" Enabled="False" Visible="False" BorderWidth="1px" ValidationGroup="InvoiceNoGroup"></asp:TextBox><asp:Button id="btnInvoiceNo" runat="server" Width="30px" Height="22px" Font-Bold="True" Enabled="False" Visible="False" ValidationGroup="InvoiceNoGroup" Text="..." UseSubmitBehavior="False"></asp:Button></TD><TD style="WIDTH: 13%">&nbsp;<asp:Button id="btnProducId" runat="server" Width="30px" Height="22px" Font-Bold="True" Enabled="False" Visible="False" Text="..." UseSubmitBehavior="False"></asp:Button></TD><TD style="VERTICAL-ALIGN: top">&nbsp;<!-- <img id="imgSalesDate" alt="Pick Date" src="../../Images/calendar.gif" style="width: 42px; height: 20px" hidefocus="hideFocus" />--></TD></TR></TBODY></TABLE></TD></TR><TR><TD vAlign=top align=left><asp:Panel id="pnlMemberId" runat="server" Width="100%" DefaultButton="btnClickMemberID"><TABLE width="100%"><TBODY><TR><TD style="WIDTH: 17%"><asp:Label id="CustomerId" runat="server" text="Member ID">
