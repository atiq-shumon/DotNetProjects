...
{
    public partial class frmOprtheterNew : AH.Shared.UI.frmSmartFormStandard
    {
        OPRMSSR.OPRWSClient accmSc = new OPRMSSR.OPRWSClient();
        public frmOprtheterNew()
        {
            InitializeComponent();
        }
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            var strResponse = MessageBox.Show("Do U want to Save?", "Save Button", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
        ...
        {
            var strResponse = MessageBox.Show("Do U want to Update?", "Update Button", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
            if (strResponse == DialogResult.Yes)
            {
