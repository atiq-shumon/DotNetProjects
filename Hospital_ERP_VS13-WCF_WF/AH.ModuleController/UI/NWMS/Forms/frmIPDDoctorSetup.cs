    ...
    public partial class frmIPDDoctorSetup : AH.Shared.UI.frmSmartFormStandard
    {
        ...
        private void cboUnit_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (cboDepartment.SelectedValue != null && cboUnit.SelectedValue != null)
            {
                ...
                cboDoctor.DataSource = new BindingSource(nwbnch.GetOPDDoctorDict(cboDepartment.SelectedValue.ToString(), cboUnit.SelectedValue.ToString()), null);
            }
        }
        ...
        {
            List<IPDDoctor> oIPDDoc = nwbnch.GetIPDDoctorsList().ToList();
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                short i = nwbnch.InsertIPDDoctors(oDocSetup);
                if (i == 0)
                {
