...
namespace AH.IPDShared.MODEL
{
    public class InPatient : Patient
    {
        ...
        public char dischargeFlag { set; get; }
        public DateTime ExpectedOperationDate { set; get; }
        public DateTime BedTransferDateTime { set; get; }
        public string CurrentDietTitle { set; get; }
        public decimal EmergencyAmount { set; get; }
    } 
}
