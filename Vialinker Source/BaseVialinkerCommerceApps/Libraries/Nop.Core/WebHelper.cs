        ...
        public virtual string GetThisPageUrl(bool includeQueryString, bool useSsl)
        {
            ...
            else
            {
                if (_httpContext.Request.Url != null)
                {
                    ...
                    try
                    {
                        string em = _httpContext.Request.Url.Query.Split('=')[1];
                        if(!string.IsNullOrEmpty(em) && em.Contains("@"))
                        {
                            ...
                            //System.Web.HttpContext.Current.Session["email"] = _httpContext.Request.Url.Query.Split('=')[1];
                        //url = url.ToLowerInvariant();
                        //return url + HttpContext.Current.Session["EMAIL"].ToString();
                    }
                    catch
                    {
                    }
